# Generated by Django 3.1.7 on 2021-04-29 15:56

from django.db import migrations, models
import django.db.models.deletion
import posts.storage
import posts.upload_handlers
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover', models.ImageField(storage=posts.storage.OverwriteStorage(), upload_to=posts.upload_handlers.upload_exam_cover_to, verbose_name='Answer Sheet')),
                ('template', models.FileField(blank=True, default='template.json', storage=posts.storage.OverwriteStorage(), upload_to=posts.upload_handlers.upload_exam_template_to)),
                ('marker', models.ImageField(blank=True, default='omr_marker.jpg', storage=posts.storage.OverwriteStorage(), upload_to=posts.upload_handlers.upload_exam_marker_to)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=20, unique=True)),
                ('cover', models.ImageField(storage=posts.storage.OverwriteStorage(), upload_to=posts.upload_handlers.upload_exam100_cover_to, verbose_name='Answer Sheet')),
                ('template', models.FileField(blank=True, default='template.json', storage=posts.storage.OverwriteStorage(), upload_to=posts.upload_handlers.upload_exam100_template_to)),
                ('marker', models.ImageField(blank=True, default='omr_marker.jpg', storage=posts.storage.OverwriteStorage(), upload_to=posts.upload_handlers.upload_exam100_marker_to)),
                ('q1', models.CharField(blank=True, choices=[('A', 'A'), ('B', 'B'), ('C', 'C'), ('D', 'D'), ('E', 'E')], max_length=10, null=True, verbose_name='Answer key:Q1')),
                ('q2', models.CharField(blank=True, choices=[('A', 'A'), ('B', 'B'), ('C', 'C'), ('D', 'D'), ('E', 'E')], max_length=10, null=True)),
                ('q3', models.CharField(blank=True, choices=[('A', 'A'), ('B', 'B'), ('C', 'C'), ('D', 'D'), ('E', 'E')], max_length=10, null=True)),
                ('q4', models.CharField(blank=True, choices=[('A', 'A'), ('B', 'B'), ('C', 'C'), ('D', 'D'), ('E', 'E')], max_length=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('processed_image', models.ImageField(storage=posts.storage.OverwriteStorage(), upload_to=posts.upload_handlers.upload_100processed_marks_image_to)),
                ...
                ('exam', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='posts.exams100')),
                ('student', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='posts.student')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('processed_image', models.ImageField(storage=posts.storage.OverwriteStorage(), upload_to=posts.upload_handlers.upload_processed_marks_image_to)),
                ('final_marks', models.CharField(blank=True, max_length=20, null=True)),
                ('q1', models.CharField(max_length=4, null=True)),
                ('q2', models.CharField(max_length=4, null=True)),
                ('q3', models.CharField(max_length=4, null=True)),
                ...
                ('q39', models.CharField(max_length=4, null=True)),
                ('q40', models.CharField(max_length=4, null=True)),
                ('exam', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='posts.exams')),
                ('student', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='posts.student')),
            ],
            options={
